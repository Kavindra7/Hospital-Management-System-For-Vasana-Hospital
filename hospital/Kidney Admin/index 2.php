...
<html lang="en">
    ...
    <body style="background-image: url(images/2853458.jpg); background-size: cover;">
				...
				if (isset($_POST['login']))
					{
						...
						$query 		= mysqli_query($con, "SELECT * FROM kidneyadmin WHERE  password='$password' and username='$username'");
