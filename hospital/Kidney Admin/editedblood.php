...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background-color: #ebf2ce;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit success</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
								...
								<?php
									include 'dbconnect.php';
										...
										$id=$_POST['id'];
										//update query
										$qry = "update kidney set name='$name', gender='$gender', dob='$dob', weight='$weight', bloodgroup='$bloodgroup', address='$address', contact='$contact', collection='$collection' where id='$id'";
