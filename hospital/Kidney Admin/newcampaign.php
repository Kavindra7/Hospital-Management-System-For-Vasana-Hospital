                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="addedcampaign.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="0715678987" type="number" name="phn" required>
                                        </div>
                                        ...
                                        <button type="submit" href="" class="btn btn-success" style="border-radius:50px">Post</button>
