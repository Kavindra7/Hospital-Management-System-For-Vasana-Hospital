...
<head>
    ...
    <title>Add Donor's Detail</title>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="added.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="name" type="text" placeholder="Example:Kavindra" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Example: Kavindra</p>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-success" class="btn btn-success" style="border: radius 50px;";>Submit Form</button>
