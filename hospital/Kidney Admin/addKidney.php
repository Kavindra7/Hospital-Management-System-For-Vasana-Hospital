...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background-color: #ebf2ce;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Kidney Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="addedblood.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Kavindra" name="name" required>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-success btn-default" style="border-radius: 50px;">Submit Form</button>
