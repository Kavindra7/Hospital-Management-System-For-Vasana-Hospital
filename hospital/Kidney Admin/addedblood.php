...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Added kidney</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$qry = "insert into kidney(name,gender,dob,weight,bloodgroup,address,contact,collection) values ('$name','$gender','$dob','$weight','$bloodgroup','$address','$contact','$collection')";
...
if(!$result){
    ...
    echo" <a href='admindashboard.php' div style='text-align: center'><h3>Go Back</h3>";

}

}else{
    echo"<h3>YOU ARE NOT AUTHORIZED TO REDIRECT THIS PAGE. GO BACK to <a href='admindashboard.php'> DASHBOARD </a></h3>";
}
