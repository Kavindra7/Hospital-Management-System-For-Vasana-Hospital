...
<html lang="en">
	<head>
		<title>Reg Users | View reports</title>
						...
						<div class="main-content" >
							<div class="wrap-content container" id="container">
								<div class="container-fluid container-fullw bg-purewhite">
									<div class="row">
										<div class="col-md-12">
											<h1>View Reports</span></h1>
	
											<table class="table table-hover" id="sample-table-1" style="background-color: purewhite;">
												<thead>
													<tr>
													...
													<tbody>
														...
														<tr>
															...
															<td><a href="view-reports.php?viewid=<?php echo $row['ID'];?>">view details</a></td>
														</tr>
														<?php 
														$cnt=$cnt+1;
 														}?>
