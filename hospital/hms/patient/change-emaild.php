									...
									<div class="row margin-top-30">
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading" style="background-color: #dbe7a6;">
													<h1>Update Gmail</h1>
												</div>
												<div class="panel-body" style="background-color: #dbe7a6;">
												<form name="registration" id="updatemail"  method="post">	
											 		<div class="form-group">
														...
														<button type="submit" name="submit" id="submit" class="btn btn-o btn-primary" style="color: red; border-radius: 20px;">Update</button>
											  	</form>
