...
<html lang="en">
	...
	<body style="background-color: purewhite;">
		<div id="app">		
			...
			<div class="app-content" style="background-color: purewhite;">
							...
							<div class="row">
								...
								<form role="form" name="edit" method="post">
										...
										<div class="form-group">
											...
											<a href="change-emaild.php" style="color: red;">Update your email id</a>
										</div>			
										...
										<div class="panel panel-antiquewhite">
