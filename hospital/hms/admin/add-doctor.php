...
<html lang="en">
	<head>
		...
		<link rel="icon" type="image/x-icon" href="/hospital/hms/admin/assets/images/logo.png">
								...
								<div class="col-md-12">
									...
									<div class="row margin-top-30">
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-purewhite">
												...
												<div class="panel-body">
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														...
														<div class="form-group">
															...
															<input type="text" name="doccontact" class="form-control"  placeholder="Enter Doctor Contact no" required="true" pattern="07[1,2,5,6,7,8][0-9]{7}" maxlength="10">
														</div>
														...
														<button type="submit" name="submit" id="submit" class="btn btn-o btn-primary" style="color: red; border-radius: 20px;">
															Submit
														</button>
													</form>
												</div>
