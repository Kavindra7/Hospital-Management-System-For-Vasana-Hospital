...
<html lang="en">
	<head>
		<title>User Session Logs Report</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">User Session Logs Report</h1>
								</div>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
						...
						<div class="container-fluid container-fullw bg-purewhite">
							<div class="row">
								<div class="col-md-12">
								<a href="datatable-user.php"><button type="button" class="btn btn-primary">Download/Print Report</button></a>
