				...
				<?php include('include/header.php');?>
					...
					<div class="main-content" >
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor Session Logs Report</h1>
								</div>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
						...
						<div class="container-fluid container-fullw bg-purewhite">
							<div class="row">
								<div class="col-md-12">
								<a href="datatable.php"><button type="button" class="btn btn-primary">Download/Print Report</button></a>
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
										<?php
											$sql=mysqli_query($con,"select * from doctorslog order by logintime ASC");
											$cnt=1;
