						...
						<div class="container-fluid container-fullw bg-purewhite">
							<div class="row">
											...
											<div class="panel panel-purewhite">
												...
												<div class="panel-body">
													...
													<form role="form" name="dcotorspcl" method="post" >
														...
														<button type="submit" name="submit" class="btn btn-o btn-primary" style="color: red; border-radius: 20px;">
															Submit
														</button>
													</form>
												</div>
								...
								<div class="col-lg-12 col-md-12">
									...
									<div class="row">
										<div class="col-md-12">
											<h5 class="over-title margin-bottom-15"> <span class="text-bold">Docter Specialization</span></h5>
