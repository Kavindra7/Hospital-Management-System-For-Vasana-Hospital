		...
		<div class="main-content" >
			<div class="wrap-content container" id="container">
				...
				<div class="panel-heading">
								<h1 style="padding-top: 20px;">Add Patient</h1>
				</div>
									...
									<div class="panel-body">
										<form role="form" name="" method="post">
											...
											<div class="form-group">
												...
												<input type="text" name="patcontact" class="form-control"  placeholder="Enter Patient Contact no" required="true"  pattern="07[1,2,5,6,7,8][0-9]{7}"  maxlength="10" pattern="[0-9]+">
											</div>
											...
											<button type="submit" name="submit" id="submit" class="btn btn-o btn-primary" style="color: red; border-radius: 20px;"> Add </button>
										</form>
									</div>
								</div>
							</div>
