				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<div class="panel-heading" >
							<h1 style="padding-top: 20px;">Edit Patient Details</h1>
						</div>
												...
												<div class="panel-body">
													<form role="form" name="" method="post">
														...
														<div class="form-group">
															...
															<input type="text" name="patcontact" class="form-control"  value="<?php  echo $row['PatientContno'];?>" required="true"  pattern="07[1,2,5,6,7,8][0-9]{7}"  maxlength="10" pattern="[0-9]+">
														</div>
