...
<html lang="en">
	...
	<body class="login" style="background-image: url(assets/images/Doctor\ Login.jpg); background-repeat: no-repeat; background-size: cover;">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login" style="background-color: transparent;">
					<form class="form-login" method="post">
						<fieldset>
						<a href="../../index.html">	<h2 style="text-align: center; padding-top: 10px; padding-bottom: 10px;"> Doctor Login</h2></a>
							<p>
