...
<head>
   ...
   <link href="../kidney vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <script src="https://kit.fontawesome.com/983e6bd632.js" crossorigin="anonymous"></script>"
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="userviewKideny.php">
                            <div class="panel-footer">
                                <span class="pull-left">View Available Details</span>
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-center">
                                    <div class="huge" style="padding-bottom: 30px;">Donate</div>
                                    <div></div>
                                </div>
                            </div>
                        </div>
                        <a href="useraddKidney.php">
                            <div class="panel-footer">
                                <span class="pull-left">Donate Now!</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
