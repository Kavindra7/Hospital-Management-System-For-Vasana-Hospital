...
<div id="wrapper" style="background-color: #a5c422;">
    ...
    <?php include 'includes/donornav.php'?>
            ...
            <div class="row">
                <div class=".col-lg-12">
                    <h1 class="page-header">Donate Kidney Section</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="background-color: #ebf2ce;">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="useraddedKidney.php" method="POST">
                                     
                                        <div class="form-group">
                                            <label>Enter Full Name</label>
                                            <input class="form-control" placeholder="Kavindra" type="text" name="name" required>
                                        </div>
