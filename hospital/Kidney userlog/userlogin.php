...
<body style="background-image: url(images/Mobile-login-Cristina.jpg); background-size: cover;">

	<div class="container h-100">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card" style="background-color: transparent;">
			
				<div class="d-flex justify-content-center form_container" style="padding-bottom: 100px;">
